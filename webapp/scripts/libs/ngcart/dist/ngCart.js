...
angular.module('ngCart.directives', [])
    ...
    .directive('ngcartAddtocart', ['ngCart', function(ngCart){
        return {
            ...
            transclude: true,
            templateUrl: 'webapp/scripts/libs/ngcart/template/ngCart/addtocart.html',
    ...
    .directive('ngcartCart', ['ngCart', function(ngCart){
        return {
            ...
            controller : 'CartController',
            scope: {},
            templateUrl: 'webapp/scripts/libs/ngcart/template/ngCart/cart.html',
            link:function(scope, element, attrs){
    ...
    .directive('ngcartSummary', ['ngCart', function(ngCart){
        return {
            ...
            scope: {},
            transclude: true,
            templateUrl: 'webapp/scripts/libs/ngcart/template/ngCart/summary.html'
        };
    }]);
